...
{
    public partial class matMuiMieng : Form
    {
        public matMuiMieng()
        {
            InitializeComponent();
        ...
        private void show()
        {
            ...
            {
                if (temp.LoaiThuoc == loaiThuoc.Matmuimieng) list.Add(temp);
            }
        ...
        private void matMuiMieng_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            temp.LoaiThuoc = loaiThuoc.Matmuimieng;
            if (thuoc.them(temp))
            {
