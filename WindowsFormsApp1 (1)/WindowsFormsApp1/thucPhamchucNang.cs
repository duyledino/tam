...
{
    public partial class thucPhamchucNang : Form
    {
        ...
        CXuLyThuoc thuoc = new CXuLyThuoc();
        ...
        private void show()
        {
            ...
            {
                if (temp.LoaiThuoc == loaiThuoc.Thucphamchucnang) list.Add(temp);
            }
        ...
        private void thucPhamchucNang_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            temp.LoaiThuoc = loaiThuoc.Thucphamchucnang;
            if (thuoc.them(temp))
            {
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            foreach (DataGridViewRow row in dataGridView1.SelectedRows)
            {
                ...
                if (temp != null)
                {
                    textBox1.Text = temp.MaT.ToString();
                    textBox2.Text = temp.TenT.ToString();
